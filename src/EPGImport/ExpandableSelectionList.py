...
#   x, y, w, h = skin.parameters.get("SelectionListDescr", (20, 2, 800, 30))
	if sz_w == 1920:
...
#   x, y, w, h = skin.parameters.get("SelectionListLock", (0, 2, 25, 25))
	if sz_w == 1920:
		x, y, w, h = (-25, 5, 40, 40)
	else:
		x, y, w, h = (-15, 2, 25, 25)
...
def expand(cat, value=True):
	...
	if cat[0][1] != value:
		# ix, iy, iw, ih = skin.parameters.get("SelectionListLock",(10, 2, 25, 25))
		if sz_w == 1920:
